              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-slate-50 p-6 rounded-lg">
                  ...
                  <p className="text-slate-700">
                    拥有10年跨境电商经验，曾服务于多家知名电商平台，专注于市场趋势分析和战略规划。
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-2">
                  ...
                  <p className="text-slate-600 text-sm mb-2">技术总监</p>
                  <p className="text-slate-700">
                    资深全栈开发者，拥有丰富的电商平台和独立站开发经验，专注于性能优化和用户体验提升。
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-2">
                  ...
                  <p className="text-slate-600 text-sm mb-2">海外营销专家</p>
                  <p className="text-slate-700">
                    拥有8年海外营销经验，精通Facebook、Google等平台广告投放，擅长跨文化营销策略制定。
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-2">
                  ...
                  <p className="text-slate-600 text-sm mb-2">内容策略师</p>
                  <p className="text-slate-700">
